...
wss.on('connection', (ws) => {
  ...
  ws.on('message', (message) => {
    console.log(`Received message: ${message}`);  // Corrected line using template literal
    ...
    const serverResponse = `Server Response: Received your message - "${message}"`;  // Corrected line using template literal
